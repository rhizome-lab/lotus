...
- **Write in TypeScript**: Write ViwoScript as standard TypeScript functions (e.g. in `verbs.ts`). The transpiler converts this to ViwoScript. Do not write raw JSON S-expressions manually.
