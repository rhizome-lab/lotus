...
The seeding process in Lotus is responsible for populating the world with initial entities, items, and verbs. This document explains how seeds are structured and how verbs are defined and loaded.
