...
**Core Infrastructure: (MAJOR PROGRESS - 85% complete)**
...
- [ ] **viwo-runtime**: Port remaining kernel opcodes to Lua FFI (`mint`, `delegate`)
- [ ] **viwo-core**: Port seed system (load entities/verbs from TypeScript DSL)

**Tests Ported: (18/20+ tests, 90% complete, 319 passing)**
